<template>
    <MainLay class="">
        <div class="capitalize mt-5 w-full min-h-[650px] flex justify-center items-center">
            <form class="md:max-w-lg flex flex-col sm:max-w-sm w-full mx-auto" @submit.prevent="createPatient()">
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" name="floating_first_name" id="floating_first_name" v-model="PatientName"
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" name="floating_last_name" id="floating_last_name" v-model="PatientFamilyName"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " required />
                ...
                <div class="flex justify-start items-center mr-4">
                    <div class="flex items-center mb-4 ">
                        <input id="default-radio-1" type="radio" value="Male" name="default-radio" v-model="gender"
                ...
                <div class="grid md:grid-cols-2 md:gap-6" v-if="isSickGuard">
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" name="floating_first_name" id="floating_first_name" v-model="SickGuardName"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " required />
                        <label for="floating_first_name"
                            class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">First
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" name="floating_last_name" id="floating_last_name" v-model="SickGuardFamilyName"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " required />
                        <label for="floating_last_name"
                            class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Last
                ...
                <div class="grid md:grid-cols-1 md:gap-6" v-if="isSickGuard">
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" name="floating_phone" id="floating_phone" v-model="SickGuardPhone"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " required />
                        <label for="floating_phone"
                ...
                <div class="w-full mx-auto mb-5 " v-if="isRoom">
                ...
                <button type="submit"
                    class="mb-10 text-white block bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
            </form>
        </div>
...
import type { GenderEnum, Room } from '~/types';
...
const PatientFamilyName = ref('')
const SickGuardName = ref('')
const SickGuardFamilyName = ref('')
const SickGuardPhone = ref('')
const gender: Ref<GenderEnum | undefined> = ref(undefined)
...
const createPatient = async () => {
    try {
        const patient = await userStore.createPatient({
            ...
            familyName: PatientFamilyName.value,
            dateOfEntry: dateOfEntry.value,
            dateOfBirth: dateOfBirth.value,
            gender: gender.value,
            description: Description.value,
            sickGuard: isSickGuard.value ? `${SickGuardName.value} ${SickGuardFamilyName.value}` : undefined,
            SickGuardPhone : isSickGuard.value ? SickGuardPhone.value : undefined
