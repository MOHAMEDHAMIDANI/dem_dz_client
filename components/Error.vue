<template>
    <div v-if="userStore.wait" class="w-full h-full absolute top-5 left-[50%] translate-x-[-50%]">
        <div id="alert-1" v-if="userStore.errorType == 1"
        ...
        <div id="alert-2" v-if="userStore.errorType == 2"
        ...
        <div id="alert-3" v-if="userStore.errorType == 3"
        ...
        <div id="alert-4" v-if="userStore.errorType == 4"
        ...
        <div id="alert-5" v-if="userStore.errorType == 5"
            class="flex items-center p-4 rounded-lg bg-gray-50 dark:bg-gray-800" role="alert">
