<template>
    <div class="relative">
        <label @click="toggleDark()"
            ...
            for="light-switch">
            <svg v-if="!isDark" class="w-4 h-4 dark:hidden" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg v-else class="w-4 h-4 hidden dark:block" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                <path class="fill-current text-slate-400"
